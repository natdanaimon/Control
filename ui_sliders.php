...
<head>
	<meta charset="utf-8" />
	<title>Metronic | UI Features - Sliders</title>
	...
	<link href="assets/plugins/jquery-ui/jquery.ui.slider.css" rel="stylesheet"/>
...
<body class="page-header-fixed">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
							Sliders <small>ui sliders, cirlce dial and more</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
	...
	<script src="assets/scripts/ui-sliders.js"></script>
