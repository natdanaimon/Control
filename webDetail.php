        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="container-fluid">
                    ...
                    $sql = " select * from webcontent where i_id = $_GET[id] ";
                    ...
                    <?php while ($objResult = mysql_fetch_array($objQuery)) { ?>
                        ...
                        <?php if (strlen($objResult["s_detail_member"]) > 0) { ?>
                            <div class="row-fluid">
                                <div class="span12">

                                    <img src="<?=$_SESSION[pathWeb]?>/assets/img/con/<?= $objResult["s_detail_member"] ?>"/>
