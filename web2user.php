                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li><a href="web2user.php">   <?= $_SESSION["_AddWeb"] ?></a>
                                </li>
                        ...
                        <div class="span12">
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                    <div class="caption"><i class="icon-bar-chart"></i><?= $_SESSION["_AddWeb"] ?></div>
                                    <div class="tools">
...
<!--                                        <a href="javascript:;" class="reload"></a>-->
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        ...
                                        <form method="post" action="web2user.php?search=search">
                        ...
                        <?php if ($_GET[search] == "search") { ?>
                            <div class="span12">
                                <div class="portlet-body form">
                                    <!-- BEGIN FORM-->
                                    <form method="post" action="Function/EditWeb2User.php">
                                                ...
                                                <div class="controls">
                                                    <select multiple="multiple" id="my_multi_select2" name="my_multi_select2[]">
                                                        ...
                                                        <optgroup  label="Casino Online">
                                                            ...
                                                            $strSql .= "  web w ";
                                                            $strSql .= "LEFT JOIN ";
                                                            $strSql .= "  web2user w2u ON w2u.i_id = w.i_id AND w2u.s_user = '" . $_POST["user_search"] . "' ";
                                                            $strSql .= "LEFT JOIN ";
                                                            $strSql .= "  user u ON u.user = w2u.s_user ";

                                                            $objQueryY = mysql_query($strSql);
                                                            ?>
                                                            <?php while ($objResultY = mysql_fetch_array($objQueryY)) { ?>
                                                                <?php if ($objResultY["s_status"] == 'Y') { ?>
                                                                    <option <?= ($objResultY["s_user"] != NULL ? "selected='selected'" : "") ?> value="<?= $objResultY["i_id"] ?>" ><?= $objResultY["s_name"] ?></option>
                                                                <?php } ?>
                                                            <?php } ?>
                                                        </optgroup>

                                                        <optgroup   label="Sport Betting">
                                                            <?php
                                                            $objQueryY = mysql_query($strSql);
                                                            ?>
                                                            <?php while ($objResultY = mysql_fetch_array($objQueryY)) { ?>
                                                                <?php if ($objResultY["s_status"] == 'N') { ?>
                                                                    <option <?= ($objResultY["s_user"] != NULL ? "selected='selected'" : "") ?> value="<?= $objResultY["i_id"] ?>"><?= $objResultY["s_name"] ?></option>
                                                                <?php } ?>
                                                            <?php } ?>
                                                        </optgroup>
