							...
							<div class="span9 article-block">
								...
								<div class="row-fluid">
									...
									<div class="span8 blog-article">
										<h2><a href="page_blog_item.php">Hello here will be some recent news..</a></h2>
										...
										<a class="btn blue" href="page_blog_item.php">
										Read more 
							...
							<div class="span3 blog-sidebar">
								...
								<div class="tabbable tabbable-custom">
									<ul class="nav nav-tabs">
										...
										<li ><a data-toggle="tab" href="#tab_1_3">Section 3</a></li>
									</ul>
