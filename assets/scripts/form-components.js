...
//             return "<img class='flag' src='assets/img/flags/" + state.id.toLowerCase() + ".png'/>&nbsp;&nbsp;" + state.text;
        ...
        function formatBank(state) {
             return "<img class='flag' src='assets/bank/" + state.id.toLowerCase() + ".png' width='25px' heigth='25px' />&nbsp;&nbsp;" + state.text;
        }
         $("#select2_sample_bank").select2({
            allowClear: true,
