...
<div id="ShowAddUser" class="modal hide fade" Style="top:100px" tabindex="-1" data-width="760">
            ...
            <div class="scroller" style="height:350px" data-always-visible="1" data-rail-visible1="1">
                <div class="row-fluid">
                    <div class="span6">
                        ...
                        <div class="input-icon left">
                            <i class="icon-user"></i>
                            <input class="m-wrap " type="text" placeholder="ชื่อ-นามสกุล" name="fullname_add"  pattern="[^'\x22]+" required/>    
                        </div>
                        <div class="input-icon left">
...
<div id="ShowEditUser" class="modal hide fade modal_edit_user" Style="top:100px; width: 300px;" tabindex="-1" data-width="300">
    <form action="/Control/Function/EditUser.php" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-body">
            <div  style="height:370px" >
                <div class="row-fluid" style="left: 5px;" >
                    <div class="span6">
                        <div class="input-icon left" style="display: nones;">
                            <i class="icon-user"></i>
                        ...
                        <div class="input-icon left">
                            <i class="icon-user"></i>
                            <input class="m-wrap " type="text" placeholder="ชื่อ" name="fullname_add"  id="fname_add"  pattern="[^'\x22]+" required/>    
                        </div>
                        <div class="input-icon left">
                            <i class="icon-phone"></i>
                        ...
                        <div class="input-icon left">
                            <div class="controls">
                                <select id="status" name="status" class="span12 chosen " data-placeholder="Choose a Category" tabindex="1" Style="color: red;font-weight: bold">
                                    <option value="1">Type (User)</option>
                                    <option value="0">Type (Admin)</option>
