        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="container-fluid">
                    <form action="Function/ContentURL.php" method="post"  enctype="multipart/form-data">
                        <!-- BEGIN PAGE HEADER-->
                        <div class="row-fluid">
                            <div class="span12">
                        ...
                        $sql = " select * from weburl where i_id = $_GET[id] LIMIT 1";
                        ...
                        while ($objResult = mysql_fetch_array($objQuery)) {
                            ...
                            $Agent = $objResult["s_url"];
                            $Member = $objResult["s_url2"];
                            $UAgent = $objResult["user_a"];
                            $UMember = $objResult["user_m"];
                            $UPAgent = $objResult["pass_a"];
                            $UPMember = $objResult["pass_m"];
                                    ...
                                    <div class="span12">
                                        <div class="input-icon left">
                                            ...
                                            <div class="row-fluid">
                                                <div class="span12">
                                                    <div class="input-icon left">
                                                        <label class="badge badge-important"><?= $_SESSION["_agents"] ?></label>
                                                    </div>
                                                    <div class="input-icon left">
                                                        <i class="icon-user"></i>
                                                        <input class="m-wrap large " type="text" name="agent_user"  value="<?= $UAgent ?>"  pattern="[^'\x22]+"  placeholder="Username Test" >    
                                                    </div>
                                                    <div class="input-icon left">
                                                        <i class="icon-key"></i>
                                                        <input class="m-wrap large " type="text" name="agent_pass" id="s_topic" value="<?= $UPAgent ?>"  pattern="[^'\x22]+" placeholder="Password Test" >    
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="row-fluid">
                            <div class="span12">
                                ...
                                <div class="row-fluid">
                                    <div class="span12">
                                        <div class="input-icon left">
                                            <label class="badge badge-info"> <?= $_SESSION["_members"] ?></label>
                                        </div>
                                        <div class="input-icon left">
                                            <i class="icon-user"></i>
                                            <input class="m-wrap large " type="text" name="member_user"  value="<?= $UMember ?>"  pattern="[^'\x22]+"  placeholder="User/Pass (Test Member)" >    
                                        </div>
                                        <div class="input-icon left">
                                            <i class="icon-key"></i>
                                            <input class="m-wrap large " type="text" name="member_pass"  value="<?= $UPMember ?>"  pattern="[^'\x22]+" placeholder="Password Test" >    
                                        </div>
                                    </div>
                                </div>
                                <div class="row-fluid">
                                    <div class="span12">
                                        ...
                                        <div class="form-actions">
                                            <button type="submit" class="btn blue "><span class="icon-link"></span> <?= $_SESSION["_add_weburl"] ?></button>
