						...
						<div class="portlet box green">
							...
							<div class="portlet-body form">
								...
								<div id="long" class="modal hide fade" tabindex="-1" data-replace="true">
									...
									<div class="modal-body">
										<a class="btn red" data-toggle="modal" href="#notlong" style="position: absolute; top: 50%; right: 12px">Not So Long Modal</a>
								...
								<div id="notlong" class="modal hide fade" tabindex="-1" data-replace="true">
									...
									<div class="modal-body">
										...
										<img style="height: 300px" src="http://i.imgur.com/KwPYo.jpg" alt="">
									</div>
									<div class="modal-footer">
										<button type="button" data-dismiss="modal" class="btn">Close</button>
									</div>
								</div>
								<div id="ajax-modal" class="modal hide fade" tabindex="1">fsdfsdf</div>
							</div>
						</div>
						<!-- END PORTLET-->
					</div>
