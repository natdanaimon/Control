			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
							Buttons <small>buttons, icons, dropdowns and more</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
				...
				<div class="row-fluid">
					<div class="span6">
						...
						<div class="portlet box red">
							...
							<div class="portlet-body">
								<h4>Examples to use buttons with font awesome icons.</h4>
								<p>
								...
								<h4>Examples to use buttons with glyphicon halflings icons.</h4>
								<p>
								...
								<h4>Buttons with both text and icon.</h4>
								<p>   
									<a href="#" class="btn red"><i class="icon-trash"></i> Delete Item</a>
								...
								<h4>Toolbar with Buttons, Button Groups & Dropdowns</h4>
								<div class="btn-toolbar">
									<a href="#" class="btn blue">New</a>
									<div class="btn-group">
										<a href="#" class="btn red">Spam</a>
										<div class="btn-group">
											<button class="btn blue dropdown-toggle" data-toggle="dropdown">Tools <i class="icon-angle-down"></i>
											</button>
											<ul class="dropdown-menu">
												<li><a href="#">Inbox <span class="badge badge-success">2</span></a></li>
												<li><a href="#">Another action</a></li>
												<li><a href="#">Something else here</a></li>
												<li class="divider"></li>
												<li><a href="#">Separated link <span class="badge badge-important">5</span></a></li>
											</ul>
										</div>
										<a href="#" class="btn yellow">Delete</a>
									</div>
									<div class="btn-group">
										<div class="btn-group">
											<button class="btn green dropdown-toggle" data-toggle="dropdown">Action <i class="icon-angle-down"></i>
											</button>
											<ul class="dropdown-menu bottom-up">
												<li><a href="#">Action <span class="badge badge-warning">6</span></a></li>
												<li><a href="#">Another action</a></li>
												<li><a href="#">Something else here <span class="badge badge-info">7</span></a></li>
												<li class="divider"></li>
												<li><a href="#">Separated link <span class="badge badge-invert">4</span></a></li>
											</ul>
										</div>
										<a href="#" class="btn purple">Labels</a>
									</div>
									<a href="#" class="btn">More</a>
								</div>
								<h4>Toolbar with Buttons, Button Groups & Hoverable Dropdowns</h4>
								<div class="btn-toolbar">
									<a href="#" class="btn blue">New</a>
									<div class="btn-group">
										<a href="#" class="btn red">Spam</a>
										<div class="btn-group">
											<button class="btn blue dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true">Tools <i class="icon-angle-down"></i>
											</button>
											<ul class="dropdown-menu">
									...
									<div class="btn-group">
										<div class="btn-group">
											<button class="btn green dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true">Action <i class="icon-angle-down"></i>
											</button>
											<ul class="dropdown-menu bottom-up">
												<li><a href="#">Action</a></li>
												<li><a href="#">Another action</a></li>
					...
					<div class="span6">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>Social Icons(Colored)</div>
								<div class="tools">
									<a href="javascript:;" class="collapse"></a>
									<a href="#portlet-config" data-toggle="modal" class="config"></a>
									<a href="javascript:;" class="reload"></a>
						...
						<div class="portlet box blue tabbable">
							<div class="portlet-title">
								<div class="caption">
									...
									<span class="hidden-480">Dropdowns</span>
								</div>
							</div>
							<div class="portlet-body form">
								<div class="tabbable portlet-tabs">
									<ul class="nav nav-tabs">
										<li><a href="#dropdown_2" data-toggle="tab">Hoverable</a></li>
										<li class="active"><a href="#dropdown_1" data-toggle="tab">Default</a></li>
									</ul>
									<div class="tab-content">
										<div class="tab-pane active" id="dropdown_1">
											...
											<div class="btn-group">
												...
												<ul class="dropdown-menu">
													<li><a href="#">Settings <span class="badge badge-success">3</span></a></li>
													<li><a href="#">Preferences</a></li>
													<li><a href="#">Window Options</a></li>
													<li><a href="#">Help <span class="badge badge-important">7</span></a></li>
												</ul>
											</div>
											<div class="btn-group">
												...
												<ul class="dropdown-menu">
													<li><a href="#">Action</a></li>
													<li><a href="#">Another action <span class="badge badge-warning">2</span></a></li>
													<li><a href="#">Something else here</a></li>
													<li class="divider"></li>
													<li><a href="#">Separated link <span class="badge badge-info">7</span></a></li>
												</ul>
											</div>
											<div class="btn-group">
												...
												<ul class="dropdown-menu">
													<li><a href="#">Action <span class="badge badge-inverse">7</span></a></li>
													<li><a href="#">Another action</a></li>
													<li><a href="#">Something else here</a></li>
													<li class="divider"></li>
													<li><a href="#">Separated link <span class="badge">4</span></a></li>
												</ul>
											</div>
										...
										<div class="tab-pane" id="dropdown_2">
											<h4>Hoverable Dropdown Buttons</h4>
											<div class="btn-group">
											...
											<div class="btn-group">
												<button class="btn red dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true">Primary <i class="icon-angle-down"></i></button>
												<ul class="dropdown-menu">
													<li><a href="#">Action <span class="badge badge-warning">7</span></a></li>
													<li><a href="#">Another action <span class="badge badge-important">2</span></a></li>
													<li><a href="#">Something else here</a></li>
													<li class="divider"></li>
													<li><a href="#">Separated link <span class="badge badge-info">4</span></a></li>
												</ul>
											</div>
											<div class="btn-group">
												<button class="btn purple dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true">Success <i class="icon-angle-down"></i>
												</button>
												<ul class="dropdown-menu">
													<li><a href="#">Action <span class="badge badge-inverse">7</span></a></li>
													<li><a href="#">Another action</a></li>
											...
											<div class="btn-toolbar hide">
												<div class="btn-group">
													<button class="btn green dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true">Success <i class="icon-angle-down"></i>
													</button>
													<ul class="dropdown-menu">
														<li><a href="#">Action</a></li>
														<li><a href="#">Another action</a></li>
												...
												<!-- /btn-group -->
												<div class="btn-group">
													<button class="btn blue dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true">Info <i class="icon-angle-down"></i>
													</button>
													<ul class="dropdown-menu">
														<li><a href="#">Action</a></li>
														<li><a href="#">Another action</a></li>
												...
												<!-- /btn-group -->
												<div class="btn-group">
													<button class="btn black dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true">Inverse <i class="icon-angle-down"></i>
													</button>
													<ul class="dropdown-menu opens-left">
														<li><a href="#">Action</a></li>
														<li><a href="#">Another action</a></li>
											...
											<h4>Hoverable Dropdown Buttons with Icons</h4>
											<div class="btn-toolbar">
												<div class="btn-group">
											...
											<div class="well">
												<h4>Hoverable Dropdown Buttons Dropdown with Checkboxes.</h4>
												<div class="btn-group">
													<a class="btn green" href="#" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true">
													Options #1
													<i class="icon-angle-down"></i>
											...
											<div class="well">
												<h4>Hoverable Dropup Buttons.</h4>
												<div class="btn-group">
													<button class="btn blue dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="true">Info <i class="icon-angle-down"></i>
													</button>
													<ul class="dropdown-menu bottom-up">
