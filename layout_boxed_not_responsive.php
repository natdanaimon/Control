...
<head>
	<meta charset="utf-8" />
	<title>Metronic | Layouts - Non-Responsive Boxed Layout</title>
				...
				<div class="container-fluid">
					...
					<div class="row-fluid">
						<div class="span12">
							...
							<h3 class="page-title">
								Non-Responsive Boxed Layout <small>non-responsive boxed layout</small>
							</h3>
							<ul class="breadcrumb">
								<li>
									<i class="icon-home"></i>
								...
								<li><a href="#">Non-Responsive Boxed Layout</a></li>
							</ul>
