...
//    exit("<script>alert('กรุณาใส่ข้อมูลวันที่เริ่มต้นของบิล !');history.back();</script>");
    $_SESSION["VALIDATEION_FORM"] = TRUE;
    $_SESSION["VALIDATEION_MSG"] = "กรุณาใส่ข้อมูลวันที่เริ่มต้นของบิล";
...
//    exit("<script>alert('กรุณาใส่ข้อมูลวันที่เริ่มต้นของบิล !');history.back();</script>");
    $_SESSION["VALIDATEION_FORM"] = TRUE;
    $_SESSION["VALIDATEION_MSG"] = "กรุณาใส่ข้อมูลวันที่สิ้นสุดของบิล";
    header("location:create_bill_2_edit.php?billno=$_SESSION[generateBill]&user=$_SESSION[form_user]");
    exit(0);
}
...
if (!$flgDate) {
// exit("<script>alert('กรุณาเลือก วันที่เริ่มต้น ให้น้อยกว่า วันที่สิ้นสุด !');history.back();</script>");
//    echo "<script>alert('กรุณาเลือก วันที่เริ่มต้น ให้น้อยกว่า วันที่สิ้นสุด !');history.back();</script>";
    $_SESSION["VALIDATEION_FORM"] = TRUE;
    $_SESSION["VALIDATEION_MSG"] = "วันที่เริ่มต้น ต้องน้อยกว่าหรือเท่ากับ วันที่สิ้นสุด";
    header("location:create_bill_2_edit.php?billno=$_SESSION[generateBill]&user=$_SESSION[form_user]");
    exit(0);
}
...
if ($flgEmtry) {
//    exit("<script>alert('กรุณาใส่ข้อมูลให้ครบถ้วน !');history.back();</script>");
    $_SESSION["VALIDATEION_FORM"] = TRUE;
    $_SESSION["VALIDATEION_MSG"] = "กรุณาใส่ข้อมูลให้ครบถ้วน";
    header("location:create_bill_2_edit.php?billno=$_SESSION[generateBill]&user=$_SESSION[form_user]");
    exit(0);
}
if (!$flgInt) {
//    exit("<script>alert('กรุณาใส่ข้อมูลเฉพาะตัวเลข !');history.back();</script>");
    $_SESSION["VALIDATEION_FORM"] = TRUE;
    $_SESSION["VALIDATEION_MSG"] = "กรุณาใส่ข้อมูลเฉพาะตัวเลข";
    header("location:create_bill_2_edit.php?billno=$_SESSION[generateBill]&user=$_SESSION[form_user]");
    exit(0);
}
if ($flgZero) {
                                        ...
                                        <div class="form-wizard">
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane active" id="tab3">
                                                    ...
                                                    <h3 class="block"><?= $_SESSION["_confirm_edit_bill"] ?> <font color="blue"><b>#<?= $generateBill ?> </b></font></h3>
...
//                                                    $strSql = "select * from web";
                                            ...
                                            <div class="form-actions clearfix">
                                                ...
                                                <a  onclick="goBack();"   class="btn alert-info ">  <i class="m-icon-swapleft"></i> <?= $_SESSION["_back"] ?> </a>
