            ...
            <div class="page-content">
                ...
                <div class="container-fluid">
                    ...
                    while ($objResult = mysql_fetch_array($objQuery)) {
                        $user = "USERNAME : " . (trim($objResult["user_m"]) != "" ? $objResult["user_m"] : "xxx");
                        $pass = "PASSWORD : " . (trim($objResult["pass_m"]) != "" ? $objResult["pass_m"] : "xxx");
                        $txtURL = $objResult["s_url2"];
                    }
                    ?>
...
<!--                                        <label class="badge badge-important"><i class=" icon-link" ></i> -->
                                        <h3 Style="color: #0099FF"> <strong>  <?= $_SESSION["_links_member"] ?> </strong> </h3>
