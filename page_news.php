			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
							News <small>news listing and view samples</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
				...
				<div class="row-fluid">
					<div class="span12 news-page">
						...
						<div class="row-fluid">
							<div class="span5">
									...
									<div class="carousel-inner">
										<div class="active item">
											...
											<div class="carousel-caption">
												<h4><a href="page_news_item.php">First Thumbnail label</a></h4>
										...
										<div class="item">
											...
											<div class="carousel-caption">
												<h4><a href="page_news_item.php">Second Thumbnail label</a></h4>
												<p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor.</p>
											</div>
										</div>
										<div class="item">
											...
											<div class="carousel-caption">
												<h4><a href="page_news_item.php">Third Thumbnail label</a></h4>
												<p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor.</p>
											</div>
										</div>
									</div>
								...
								<div class="news-blocks">
									<h3><a href="page_news_item.php">Google Glass Technology..</a></h3>
									...
									<a href="page_news_item.php" class="news-block-btn">
									Read more
									<i class="m-icon-swapright m-icon-black"></i>                              
									</a>                          
								</div>
								<div class="news-blocks">
									<h3><a href="page_news_item.php">Sint occaecati cupiditat</a></h3>
									<div class="news-block-tags">
								...
								<div class="news-blocks">
									<h3><a href="page_news_item.php">Accusamus et iusto odio</a></h3>
									<div class="news-block-tags">
										<strong>CA, USA</strong>
										<em>3 hours ago</em>
									</div>
							...
							<div class="span4">
								...
								<div class="news-blocks">
									<h3><a href="page_news_item.php">Odio dignissimos ducimus</a></h3>
									<div class="news-block-tags">
										<strong>Berlin, Germany</strong>
										<em>2 hours ago</em>
									</div>
									<p><img class="news-block-img pull-right" src="assets/img/gallery/image3.jpg" alt="">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident</p>
									<a href="page_news_item.php" class="news-block-btn">
									Read more
									<i class="m-icon-swapright m-icon-black"></i>                              
									</a>                          
								...
								<div class="news-blocks">
									...
									<p><img class="news-block-img pull-right" src="assets/img/gallery/image3.jpg" alt="">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint non provident</p>
									<a href="page_news_item.php" class="news-block-btn">
									Read more
									<i class="m-icon-swapright m-icon-black"></i>                              
									</a>                          
							...
							<div class="span3">
								...
								<div class="news-blocks">
									<h3><a href="page_news_item.php">Vero eos et accusam</a></h3>
									<div class="news-block-tags">
										<strong>CA, USA</strong>
										<em>3 hours ago</em>
									</div>
									<p><img class="news-block-img pull-right" src="assets/img/gallery/image2.jpg" alt="">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident</p>
									<a href="page_news_item.php" class="news-block-btn">
									Read more
									<i class="m-icon-swapright m-icon-black"></i>                              
									</a>                          
								...
								<div class="news-blocks">
									<h3><a href="page_news_item.php">Sias excepturi sint occae</a></h3>
									<div class="news-block-tags">
						...
						<div class="row-fluid">
							...
							<div class="span6">
								<div class="news-blocks">
									<h3><a href="page_news_item.php">Pusto odio dignissimos ducimus i quos dolores et qui blanditiis praesentium..</a></h3>
									<div class="news-block-tags">
										<strong>CA, USA</strong>
										<em>3 hours ago</em>
									</div>
									<p><img class="news-block-img pull-right" src="assets/img/gallery/image2.jpg" alt="">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident iti.. </p>
									<a href="page_news_item.php" class="news-block-btn">
									Read more
									<i class="m-icon-swapright m-icon-black"></i>                              
									</a>                          
								...
								<div class="row-fluid">
									<div class="span6 news-blocks">
										<h3><a href="page_news_item.php">Vero eos et accusamus et iusto od qui..</a></h3>
										<div class="news-block-tags">
											<strong>CA, USA</strong>
											<em>3 hours ago</em>
										</div>
