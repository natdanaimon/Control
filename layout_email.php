...
<head>
	<meta charset="utf-8" />
	<title>Metronic | Layouts - Email Templates</title>
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
							Email Templates <small>marketing and system email templates</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="mail-template">
							...
							<ul class="inline">
								<li class="color-black tooltips" data-original-title="Click to preview the template" ><a href="email1.php" target="_blank">&nbsp;</a></li>
								<li class="color-darkblue tooltips" data-original-title="Click to preview the template"><a href="email2.php" target="_blank">&nbsp;</a></li>
								<li class="color-lightblue tooltips" data-original-title="Click to preview the template"><a href="email3.php" target="_blank">&nbsp;</a></li>
								<li class="color-red tooltips" data-original-title="Click to preview the template"><a href="email4.php" target="_blank">&nbsp;</a></li>
								<li class="color-green tooltips" data-original-title="Click to preview the template"><a href="email5.php" target="_blank">&nbsp;</a></li>
							</ul>
						</div>
						<div class="mail-template">
							<h4>System Email Template</h4>
							<ul class="inline">
								<li class="color-black tooltips" data-original-title="Click to preview the template"><a href="email6.php" target="_blank">&nbsp;</a></li>
							</ul>
						</div>
						<!--end span9-->                                   
					</div>
