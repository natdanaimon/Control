                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li><a href="#">   <?= $_SESSION["_billcreate"] ?></a>
                                </li>
                        ...
                        <div class="span12">
                            <div class="portlet box blue" id="form_wizard_1">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-reorder"></i> <?= $_SESSION["_billcreate"] ?> - <span class="step-title"><?= $_SESSION["_step"] ?> 1 - 4</span>
                                    </div>
                                                ...
                                                <div class="tab-pane " id="tab2">
                                                        ...
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <div class="input-append date date-picker" data-date="102/2012" data-date-format="mm/yyyy" data-date-viewmode="years" data-date-minviewmode="months">
                                                                    <input class="m-wrap m-ctrl-medium date-picker" readonly="" size="16" type="text" value="" name="d_start" id="d_start"><span class="add-on"><i class="icon-calendar"></i></span>
                                                                </div>
                                                    ...
                                                    <div class="control-group ">
                                                        ...
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <div class="input-append date date-picker" data-date="102/2012" data-date-format="mm/yyyy" data-date-viewmode="years" data-date-minviewmode="months">
                                                                    <input class="m-wrap m-ctrl-medium date-picker" readonly="" size="16" type="text" value="" name="d_end" id="d_end"><span class="add-on"><i class="icon-calendar"></i></span>
                                                                </div>
                                                    ...
                                                    <?php
                                                    $sql = " select * from web order by s_name ";
                                                    $objQuery = mysql_query($sql);
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls">
                                                                    <div class="input-append " >
                                                                        <input class="m-wrap m-ctrl-medium "  size="16" type="text" value="" name="d_end" id="d_end"><span class="add-on"> <i class="icon-plus"></i> </span>
                                                                    </div>
                                                                    <span for="d_end" class="validate-inline valid ok"></span>
                                                                    <div class="input-append " >
                                                                        <input class="m-wrap m-ctrl-medium "  size="16" type="text" value="" name="d_end" id="d_end"><span class="add-on"><i class="icon-minus"></i></span>
                                                                    </div>
                                                                    <span for="d_end" class="validate-inline valid ok"></span>
                                                                </div>
