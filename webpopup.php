        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li><a href="webpopup.php">   <?= $_SESSION["_newpopup"] ?></a>
                                </li>
                    ...
                    <form action="/Control/Function/Addpopup.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="control-group">
                            <div class="controls">
                                <div class="switch" data-on="success" data-off="warning">
                                    <input type="checkbox" name="add_status" value="Y" checked class="toggle"/>
                                </div>
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-bullhorn"></i><?= $_SESSION["_newpopup"] ?></div>
                            <div class="tools">
...
//
                                $sql = " select id, s_Image, s_subject, s_status, DATE_FORMAT(d_create,'%d-%m-%Y') as d_create , d_change  from new_popup order by  s_status  desc ";
...
<!--                                                    <th style="width:8px;"><input type="checkbox" class="group-checkable" data-set="#sample_1 .checkboxes" /></th>-->
                                ...
                                <tbody>
                                    <?php while ($objResult = mysql_fetch_array($objQuery)) { ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td align="center">       <img src="assets/img/popup/<?= $objResult["s_Image"] ?>" alt="" width="50" height="50" /></td>
                                            <td align="center"><?= $objResult["s_subject"] ?></td>
                                            <td align="center" ><?= ($objResult["s_status"] == "Y" ? "<span class='badge badge-success'>Active</span>" : "<span class='badge badge-important'>Cancel</span>") ?></td>
                                                ...
                                                <div class="btn-toolbar label-warning ">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li ><a href="/Control/Function/DeletePopup.php?id=<?= $objResult["id"] ?>&filename=<?= $objResult["s_Image"] ?>" class="btn red" ><i class="icon-trash"></i> <?= $_SESSION["action_delete"] ?></a></li>
    ...
    <script type="text/javascript">
        ...
        $('#myModalAddPOPUPSuccess').modal('show');
        $('#myModalAddPOPUPFail').modal('show');
