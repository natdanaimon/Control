			...
			<ul class="page-sidebar-menu">
				...
				<li>
					...
					<ul class="sub-menu">
						...
						<li><a href="index.php">2 Columns (Left)</a></li>
						<li><a href="index.php">2 Columns (Right)</a></li>
					</ul>
				</li>
			</ul>
		</div>
										...
										<div class="active item">
											<div class="row-fluid">
												<div class="span7 margin-bottom-20 margin-top-20 animated rotateInUpRight">
													...
													<a href="index.php" class="btn red big xlarge">
													Take a tour
													<i class="m-icon-big-swapright m-icon-white"></i>                                
													</a>
												</div>
												<div class="span5 animated rotateInDownLeft">
													<a href="index.php"><img src="assets/img/pages/img1.png" alt=""></a>
												</div>
											</div>
										</div>
										<div class="item">
											<div class="row-fluid">
												<div class="span5 animated rotateInUpRight">
													<a href="index.php"><img src="assets/img/pages/img1_2.png" alt=""></a>
												</div>
												<div class="span7 margin-bottom-20 animated rotateInDownLeft">
													...
													<a href="index.php" class="btn green big xlarge">
													But it today
													<i class="m-icon-big-swapright m-icon-white"></i>                                
													</a>
												</div>
							...
							<div class="container">
								<div class="row-fluid">
									<div class="span5 margin-bottom-20">
										<a href="index.php"><img src="assets/img/pages/img2.png" alt=""></a>
									</div>
									<div class="span7">
										<h2>Metronic viverra vehicula sem ut volutpat</h2>
										<p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique. Pellentesque viverra vehicula sem ut volutpat. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut non libero magna. Sed et quam lacus. Fusce condimentum eleifend enim a feugiat.</p>
										<p>Lunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga. Et harum quidem rerum facilis est et expedita distinctio lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut non libero consectetur adipiscing elit magna. Sed et quam lacus. Fusce condimentum eleifend enim a feugiat.</p>
										<a href="index.php" class="btn blue big xlarge">
										Learn more
										<i class="m-icon-big-swapright m-icon-white"></i>                                
										</a>
									</div>
						...
						<div class="block-transparent">
							<div class="container">
								<div class="row-fluid margin-bottom-20">
									...
									<div class="span6 margin-bottom-20">
										<a href="index.php"><img src="assets/img/pages/img3.png" alt=""></a>
									</div>
								</div>
								<div class="row-fluid">
									<div class="span6">
										<a href="index.php"><img src="assets/img/pages/img4.png" alt=""></a>
									</div>
									<div class="span6 margin-bottom-20">
								...
								<div class="row-fluid">
									...
									<div class="span4">
										...
										<ul class="unstyled blog-images">
											...
											<li><a href="#"><img src="assets/img/blog/8.jpg" alt=""></a></li>
											<li><a href="#"><img src="assets/img/blog/10.jpg" alt=""></a></li>
											<li><a href="#"><img src="assets/img/blog/11.jpg" alt=""></a></li>
											<li><a href="#"><img src="assets/img/blog/1.jpg" alt=""></a></li>
											<li><a href="#"><img src="assets/img/blog/2.jpg" alt=""></a></li>
											<li><a href="#"><img src="assets/img/blog/7.jpg" alt=""></a></li>
										</ul>
									</div>
									<div class="span4">
										<h3>Stay Tuned</h3>
