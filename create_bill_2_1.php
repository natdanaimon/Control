                        ...
                        <div class="span12">
                            <div class="portlet box blue" id="form_wizard_1">
                                ...
                                <div class="portlet-body form">
                                    <form action="create_bill_3.php" id="frm_" class="form-horizontal" method="post" novalidate="novalidate" onsubmit="checkform();">
                                                            ...
                                                            <div class="controls">
                                                                <div class="input-append">   
                                                                    ...
                                                                    <input class="m-wrap"  type="text"  name="tmpD_<?= $objResult["i_id"] ?>" 
                                                                           id="tmpD_<?= $objResult["i_id"] ?>"  value="0"
                                                                           onchange="formatCells(this.value, 'tmpD',<?= $i ?>)"
                                                                           required style="text-align:right;padding-right:2px;"/>
                                                                    <font color="green"><span class="add-on"><i class="icon-usd"></i> </span></font>
                                                                </div>
                                                                <!--                                                                &nbsp;&nbsp;&nbsp;&nbsp;
                                                                                                                                <div class="input-append ">   
                                                                
                                                                                                                                    <input class="m-wrap "  type="text" pattern="[0-9]" name="tmpC_<?= $objResult["i_id"] ?>" value="0" required style="text-align:right;padding-right:2px;"/>
                                                                
                                                                                                                                    <font color="red"><span class="add-on"><i class="icon-usd"></i> -</span></font>
                                                                                                                                </div>-->
                                                            </div>
...
//                                                              document.getElementById(group + "_" + arrJS[1]).value = arrGroup[1];
                                            ...
                                            <div class="form-actions clearfix">
                                                ...
                                                <br/>
                                                <br/>
                                                <a href="create_bill_1.php"   class="btn alert-info ">  <i class="m-icon-swapleft"></i> <?= $_SESSION["_back"] ?> </a>
