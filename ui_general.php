                ...
                <div class="container-fluid">
                        ...
                        <div class="span12">
                            ...
                            <div class="portlet ">
                                ...
                                <div class="portlet-body">
                                    <div class="alert" id="testhide" hidden="true">
                                        <button class="close" data-dismiss="alert"></button>
                                        <strong>Warning!</strong> sasasasour monthly traffic is reaching limit.
                                    </div>
                    ...
                    <div class="row-fluid">
                        <div class="span6">
                            ...
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                    <div class="caption"><i class="icon-cogs"></i>Tooltips In Slim Scroll</div>
                                    <div class="tools">
                                        <a href="javascript:;" class="collapse"></a>
                                        <a href="#portlet-config" data-toggle="modal" class="config"></a>
                                        <a href="javascript:;" class="reload"></a>
                                ...
                                <div class="portlet-body">
                                    <div class="scroller" style="min-height:150px" data-always-visible="1" data-rail-visible="0">
                                        <p>
                                        ...
                                        <p>
                                            Tight pants next level keffiyeh 
                                            <a href="#" class="tooltips" data-container="body" data-original-title="Default tooltip">you probably</a> 
                                            haven't heard of them. 
                                            Photo booth beard raw denim letterpress vegan messenger bag stumptown. Farm-to-table seitan, mcsweeney's fixie sustainable quinoa 8-bit american apparel 
                                            <a href="#" class="tooltips" data-container="body" data-original-title="Another tooltip">have a</a> 
                                            terry richardson vinyl chambray.
                                            <a href="#" class="tooltips" title="12" data-container="body" data-original-title="The last tip!">twitter handle</a> 
                                            freegan cred raw denim single-origin coffee viral.
                                        </p>
                                        <p>
                                            <button class="btn tooltips" data-container="body" data-placement="top" data-original-title="Tooltip in top">Top</button>
                            ...
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption"><i class="icon-cogs"></i>Popovers In Slim Scroll</div>
                                    <div class="tools">
                                        <a href="javascript:;" class="collapse"></a>
                                        <a href="#portlet-config" data-toggle="modal" class="config"></a>
                                        <a href="javascript:;" class="reload"></a>
                                ...
                                <div class="portlet-body">
                                    <div class="scroller" style="min-height:150px" data-always-visible="1" data-rail-visible="0">
                                        ...
                                        <p>
                                            Tight pants next level keffiyeh 
                                            <a href="javascript:;" class="popovers" data-container="body" data-content="Popover body goes here! Popover body goes here!" data-original-title="Default Popover">trigger me on click</a> haven't heard of them. 
                                            Photo booth beard raw denim letterpress vegan messenger bag stumptown. Farm-to-table seitan, mcsweeney's fixie sustainable quinoa 8-bit american apparel 
                                            <a href="javascript:;" class="popovers" data-container="body" data-trigger="hover" data-content="Popover body goes here! Popover body goes here!" data-original-title="Another Popover">trigger me on hover</a> 
                                            terry richardson vinyl chambray. Beard stumptown, cardigans banh mi lomo thundercats. Tofu biodiesel williamsburg marfa.
                                        </p>
                                        <p>
                                            <button class="btn popovers" data-trigger="hover" data-container="body" data-placement="top" data-content="Popover body goes here! Popover body goes here!" data-original-title="Popover in top">Top</button>
